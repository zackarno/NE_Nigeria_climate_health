---
title: "NE Nigeria AWD, Malnutrition and Climate"
output: 
...
This page is meant to illustrate research progress and preliminary findings. Full code can be found on the [GitHub repository](https://github.com/zackarno/NE_Nigeria_climate_health)
...
Data cleaning code can bein found in Appendix (section: \@ref(slug))

- Total cases per LGA 
  + due to lack of data only Jere and Maiduguri were selected for further. See further justifcation (awd vs precip - lga level)
...
Data sets obtained from *[Nutrition Cluster 5Ws](https://www.humanitarianresponse.info/en/operations/nigeria/nutrition/documents/document-type/3w-4w)* .  Data sets were compiled and cleaned for analysis (For compilation/cleaning details see Appendix section \@ref(malnutritionCleaning))
...
## Correlations
- AWD vs OTP caseload
- Precipitaiton with soil moisture and AWD
...
Below code illustrates how climatic data was downloaded and aggregated from Google Earth Engine using the `rgee` package 

## Data Cleaning 


### AWD Data Cleaning  {#slug}
asdkfadslf
